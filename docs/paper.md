...
**Findings** – Fine-tuned BERTić achieves an F1-macro score of 0.810, significantly outperforming TF-IDF baselines (F1=0.711) by 13.9%. The model demonstrates balanced performance across both acceptable (F1=0.790) and offensive (F1=0.831) classes. Results confirm that transfer learning from related South Slavic languages effectively captures contextual nuances that traditional feature-based approaches miss.
